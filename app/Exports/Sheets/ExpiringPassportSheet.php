...
class ExpiringPassportSheet implements FromCollection, WithHeadings, WithTitle,WithColumnWidths
{
    public function collection()
    {
        return labourModel::ExpiringPassport()
