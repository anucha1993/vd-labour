...
class ExpiringDiseaseFactorySheet implements FromCollection, WithHeadings, WithTitle,WithColumnWidths
{
    
    public function collection()
    {
        return labourModel::ExpiringDiseaseFactory()
    ...
    public function title(): string { return 'ผลโรคโรงงาน'; }
