...
class ExpiringDiseaseConstructSheet implements FromCollection, WithHeadings, WithTitle,WithColumnWidths
{
    public function collection()
    {
        return labourModel::ExpiringDiseaseConstruct()
    ...
    public function title(): string { return 'ผลโรคก่อสร้าง'; }
