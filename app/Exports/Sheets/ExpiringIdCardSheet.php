...
class ExpiringIdCardSheet implements FromCollection, WithHeadings, WithTitle, WithColumnWidths
{
    public function collection()
    {
        return labourModel::ExpiringIdCard()
            ...
            ->map(function ($item) {
                return [
                    ...
                    $item->labour_phone,
                    $item->labour_id_card_number,
                    $item->labour_id_card_expiry ? date('d/m/Y',strtotime($item->labour_id_card_expiry)) : '-',
