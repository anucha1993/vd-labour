...
class ExpiringCidMoneySheet implements FromCollection, WithHeadings, WithTitle,WithColumnWidths
{
    public function collection()
    {
        return labourModel::ExpiringCIDConstruct()
    ...
    public function title(): string { return ' ยังไม่ได้จ่ายเงินประกันหลังยื่น CID'; }
