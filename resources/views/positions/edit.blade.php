    ...
    <div class="card card-custom mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="mb-0"><i class="bi bi-pencil-fill me-2 text-warning"></i>แก้ไขตำแหน่งงาน</h4>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('position_name_th', $position->position_name_th) }}" 
                            ...
                            <select class="form-select @error('job_group_id') is-invalid @enderror" 
                                ...
                                @foreach ($jobGroups as $jobGroup)
                                    <option value="{{ $jobGroup->job_group_id }}" 
                                            {{ old('job_group_id', $position->job_group_id) == $jobGroup->job_group_id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('position_status') is-invalid @enderror" 
                                    ...
                                    required>
                                <option value="active" {{ old('position_status', $position->position_status) == 'active' ? 'selected' : '' }}>ใช้งาน</option>
                                <option value="disable" {{ old('position_status', $position->position_status) == 'disable' ? 'selected' : '' }}>ไม่ใช้งาน</option>
                            </select>
