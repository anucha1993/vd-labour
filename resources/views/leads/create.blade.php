                            ...
                            <br>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" class="form-control" name="lead_email" value="{{ old('lead_email') }}" placeholder="example@email.com">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" name="lead_summary" id="lead_summary" rows="3" placeholder="สรุปประวัติและข้อมูลสำคัญของผู้สมัคร...">{{ old('lead_summary') }}</textarea>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control" name="lead_address" id="lead_address" rows="3" placeholder="กรอกที่อยู่ภาษาไทยหรืออังกฤษ">{{ old('lead_address') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" name="lead_additional_details" id="lead_additional_details" rows="4" 
                                          placeholder="อื่นๆ ระบุ">{{ old('lead_additional_details') }}</textarea>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            @php
                                ...
                                $selectedSkills = old('lead_skills', []);
                            @endphp
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" name="lead_car_type" id="lead_car_type">
                                    ...
                                    <option value="None" {{ old('lead_car_type') == 'None' ? 'selected' : '' }}>None (ไม่มี)</option>
                                    
                                    <optgroup label="🚗 ใบขับขี่ส่วนบุคคล (Private License)">
                                        <option value="Temporary Driving License" {{ old('lead_car_type') == 'Temporary Driving License' ? 'selected' : '' }}>
                                            Temporary Driving License (ใบอนุญาตขับรถชนิดชั่วคราว)
                                        </option>
                                        <option value="Private Car Driving License" {{ old('lead_car_type') == 'Private Car Driving License' ? 'selected' : '' }}>
                                            Private Car Driving License (ใบอนุญาตขับรถยนต์ส่วนบุคคล)
                                        </option>
                                        <option value="Private Three-wheeled Car Driving License" {{ old('lead_car_type') == 'Private Three-wheeled Car Driving License' ? 'selected' : '' }}>
                                            Private Three-wheeled Car (ใบอนุญาตขับรถยนต์สามล้อส่วนบุคคล)
                                        </option>
                                        <option value="Motorcycle Driving License" {{ old('lead_car_type') == 'Motorcycle Driving License' ? 'selected' : '' }}>
                                            Motorcycle Driving License (ใบอนุญาตขับรถจักรยานยนต์ส่วนบุคคล)
                                        </option>
                                    </optgroup>
                                    
                                    <optgroup label="🚌 ใบขับขี่สาธารณะ (Public License)">
                                        <option value="Public Car Driving License" {{ old('lead_car_type') == 'Public Car Driving License' ? 'selected' : '' }}>
                                            Public Car Driving License (ใบอนุญาตขับรถยนต์สาธารณะ)
                                        </option>
                                        <option value="Public Three-wheeled Car Driving License" {{ old('lead_car_type') == 'Public Three-wheeled Car Driving License' ? 'selected' : '' }}>
                                            Public Three-wheeled Car (ใบอนุญาตขับรถยนต์สามล้อสาธารณะ)
                                        </option>
                                        <option value="Public Motorcycle Driving License" {{ old('lead_car_type') == 'Public Motorcycle Driving License' ? 'selected' : '' }}>
                                            Public Motorcycle License (ใบอนุญาตขับรถจักรยานยนต์สาธารณะ)
                                        </option>
                                    </optgroup>
                                    
                                    <optgroup label="🚚 ใบขับขี่รถขนส่ง (Transport License)">
                                        <option value="Category 2 (บ.2)" {{ old('lead_car_type') == 'Category 2 (บ.2)' ? 'selected' : '' }}>
                                    ...
                                    <optgroup label="🌍 ใบขับขี่ประเภทอื่นๆ (Other License)">
                                        <option value="International Driving Permit" {{ old('lead_car_type') == 'International Driving Permit' ? 'selected' : '' }}>
                                            International Driving Permit (ใบอนุญาตขับรถระหว่างประเทศ)
                                        </option>
                                        <option value="Road Roller Driving License" {{ old('lead_car_type') == 'Road Roller Driving License' ? 'selected' : '' }}>
                                ...
                                <select class="form-control select2-recommender" name="lead_recommender_staff_sub_id">
                                    ...
                                    @foreach($staffSubs as $staffSub)
                                        <option value="{{ $staffSub->staff_sub_id }}" 
                                                {{ old('lead_recommender_staff_sub_id') == $staffSub->staff_sub_id ? 'selected' : '' }}>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            if (photoInput.files.length > 0) {
                ...
                console.log('ไม่มีไฟล์รูปภาพที่เลือก');
            }
        });
