...
<head>
    ...
    <title>Resume Template 5 - {{ $lead->getFullNameAttribute() }}</title>
...
<body>
    ...
    <div class="resume-container">
        <div class="text-center mb-4"><h2 class="text-danger">Resume Template 5</h2><p class="text-muted">ฟอรมเปลารอการปรบแตง</p></div>
        ...
        <div class="mt-4 p-4 border rounded"><h5> Template 5 - พรอมใหปรบแตง</h5><p>ฟอรมนพรอมใหคณปรบแตง Layout และเพมขอมลตามตองการ</p></div>
    </div>
