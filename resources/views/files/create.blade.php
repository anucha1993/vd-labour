    ...
    <div class="card card-custom mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="mb-0"><i class="bi bi-plus-circle me-2 text-primary"></i>เพิ่มประเภทเอกสาร</h4>
                <a href="{{ route('file-manage.index') }}" class="btn btn-secondary">
                    <i class="bi bi-arrow-left"></i> กลับ
                </a>
            </div>

            <form action="{{ route('file-manage.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('file_manage_name') }}" 
                               placeholder="เช่น ก่อสร้าง, โรงงาน"
                               required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('file_manage_status') is-invalid @enderror" 
                            ...
                            <option value="active" {{ old('file_manage_status') == 'active' ? 'selected' : '' }}>ใช้งาน</option>
                            <option value="inactive" {{ old('file_manage_status') == 'inactive' ? 'selected' : '' }}>ไม่ใช้งาน</option>
                        </select>
