                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mt-3">
                        ...
                        <select name="labour_status" class="form-select">
                            ...
                            <option @if($request->labour_status == 'hold') selected @endif  value="hold">ชะลอดำเนินการ</option>
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <select name="labour_examination[]" class="form-select selectMulti text-dark" multiple="multiple"
                            ...
                            @forelse ($examinationRound as $item)
                                <option 
                                @if($request->labour_examination && in_array($item->examination_round_id, (array)$request->labour_examination, true)) selected @endif
