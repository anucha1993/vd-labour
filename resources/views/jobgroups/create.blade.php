    ...
    <div class="card card-custom mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="mb-0"><i class="bi bi-plus-circle-fill me-2 text-primary"></i>เพิ่มกลุ่มงาน</h4>
                <a href="{{ route('jobgroups.index') }}" class="btn btn-secondary">
                    <i class="bi bi-arrow-left"></i> กลับ
                </a>
            </div>

            <form action="{{ route('jobgroups.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('job_group_status') is-invalid @enderror" 
                                    ...
                                    required>
                                <option value="active" {{ old('job_group_status', 'active') == 'active' ? 'selected' : '' }}>ใช้งาน</option>
                                <option value="disable" {{ old('job_group_status') == 'disable' ? 'selected' : '' }}>ไม่ใช้งาน</option>
                            </select>
